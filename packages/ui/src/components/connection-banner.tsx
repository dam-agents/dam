...
export function ConnectionBanner() {
  ...
  return (
    <div className="fixed bottom-14 left-0 right-0 z-banner flex h-11 items-center justify-center gap-2 border-t border-warning bg-warning-light px-5 text-sm font-semibold text-warning md:bottom-0">
