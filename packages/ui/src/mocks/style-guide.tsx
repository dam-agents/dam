...
const STATUS_TOKENS: {
  ...
  {
    name: "template-light",
    cssVar: "--c-template-light",
    bg: "bg-template-light",
    text: "text-template",
  },
];
  ...
  return (
    <div className="fixed inset-0 z-[200] overflow-y-auto bg-background">
      ...
      <div className="mx-auto max-w-6xl px-6 py-8 space-y-12">
        <Section
          title="Typography"
          subtitle="IBM Plex Sans (body) + IBM Plex Mono (code)"
        >
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Subtle secondary text for metadata and hints.
              </p>
            </div>
            <div>
              <Label className="text-muted-foreground">
        ...
        <Section
          title="Shadcn Tokens"
          subtitle="The core palette every component draws from"
        >
        ...
        <Section
          title="Status Tokens"
          subtitle="Custom brand tokens kept alongside shadcn"
        >
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {STATUS_TOKENS.map((t) => (
              <Swatch key={t.name} {...t} />
        ...
        <Section title="Buttons" subtitle="All variants × all sizes">
          <div className="space-y-4">
            ...
            <VariantRow label="destructive">
              ...
              <Button variant="destructive" size="icon" aria-label="icon">
                <Bell />
              </Button>
            </VariantRow>
        ...
        <Section
          title="Form inputs"
          subtitle="Input, textarea, select, checkbox, switch, radio"
        >
        ...
        <Section
          title="Cards"
          subtitle="Content container with header, content, footer"
        >
          <div className="grid md:grid-cols-2 gap-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  A subtitle that sits under the title.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-foreground/80">
                  Card body content goes here. Anything can live inside — text,
                  forms, lists, images.
                </p>
              </CardContent>
        ...
        <Section
          title="Overlays"
          subtitle="Dialog, alert-dialog, popover, tooltip, dropdown"
        >
          <div className="flex flex-wrap gap-3">
            <Dialog>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Supporting description for the dialog content.
                  </DialogDescription>
                </DialogHeader>
                <p className="text-sm text-foreground/80">
              ...
              <PopoverContent>
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Anchored to the trigger, repositions on overflow.
                  </p>
                </div>
              </PopoverContent>
            </Popover>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent>
                ...
                <DropdownMenuSeparator />
                <DropdownMenuItem>
                  <ChevronRight /> Item one
                </DropdownMenuItem>
                <DropdownMenuItem>
                  <ChevronRight /> Item two
                </DropdownMenuItem>
                <DropdownMenuSeparator />
        ...
        <Section title="Tabs" subtitle="Horizontal tab navigation">
          <Tabs defaultValue="first" className="w-full">
            ...
            <TabsContent
              value="first"
              className="text-sm text-foreground/80 p-4"
            >
              First tab content.
            </TabsContent>
            <TabsContent
        ...
        <div className="pb-12 pt-4 text-xs text-muted-foreground text-center">
          Dev-only — disable by unsetting{" "}
          <code className="font-mono">VITE_USE_MOCKS</code> in{" "}
