  ...
  return (
    ...
    >
      ...
      {needsYouCount > 0 && (
        <Badge
          variant="default"
          className="absolute -top-1 -right-1 flex h-4 min-w-4 items-center justify-center rounded-full border-0 bg-warning px-1 text-[10px] font-bold text-white hover:bg-warning"
        >
