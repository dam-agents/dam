...
type BeeRenderer = (fill: string, sleeping: boolean) => React.ReactNode;
  ...
  (fill, sleeping) => (
    <svg viewBox="0 0 125 125" fill="none">
      {sleeping ? (
        ...
        <g className="bee-eyes">
          <circle cx="50.7812" cy="62.3438" r="7.8125" fill={fill} />
          <circle cx="74.2188" cy="62.3438" r="7.8125" fill={fill} />
        </g>
      )}
      <path
  ...
  (fill, sleeping) => (
    <svg viewBox="0 0 125 125" fill="none">
      {sleeping ? (
        ...
        <g className="bee-eyes">
          <circle cx="50.7814" cy="42.7817" r="7.8125" fill={fill} />
          <circle cx="74.2185" cy="42.7817" r="7.8125" fill={fill} />
        </g>
      )}
      <path
  ...
  (fill, sleeping) => (
    <svg viewBox="0 0 125 125" fill="none">
      {sleeping ? (
        ...
        <g className="bee-eyes">
          <circle cx="74.4144" cy="31.0586" r="7.8125" fill={fill} />
          <circle cx="51.055" cy="31.1355" r="7.8125" fill={fill} />
        </g>
      )}
      <rect
        x="43.1644"
        ...
        fill={fill}
      />
      <rect x="43.1253" y="70.238" width="39.101" height="15.625" fill={fill} />
      <rect
        x="43.1253"
        y="93.6758"
        width="39.101"
  ...
  (fill, sleeping) => (
    <svg viewBox="0 0 125 125" fill="none">
      {sleeping ? (
        ...
        <g className="bee-eyes">
          <circle cx="73.8673" cy="78.5464" r="7.8125" fill={fill} />
          <circle cx="50.4296" cy="78.5464" r="7.8125" fill={fill} />
        </g>
      )}
      <path
  ...
  (fill, sleeping) => (
    <svg viewBox="0 0 125 125" fill="none">
      {sleeping ? (
        ...
        <g className="bee-eyes">
          <circle cx="74.0241" cy="23.3693" r="7.8125" fill={fill} />
          <circle cx="50.6654" cy="23.4447" r="7.8125" fill={fill} />
        </g>
      )}
      <rect x="43.008" y="39.0702" width="15.625" height="70.313" fill={fill} />
      <rect
        x="66.4457"
        y="39.0702"
        width="15.625"
  ...
  (fill, sleeping) => (
    <svg viewBox="0 0 125 125" fill="none">
      {sleeping ? (
        ...
        <g className="bee-eyes">
          <circle cx="85.9106" cy="23.3539" r="7.8125" fill={fill} />
          <circle cx="62.5966" cy="23.4293" r="7.8125" fill={fill} />
        </g>
      )}
      <path
...
/* blink: signal */
.bee-awake[data-icon="signal"] .bee-eyes > :nth-child(1) { animation: none; }
.bee-awake[data-icon="signal"] .bee-eyes > :nth-child(2) { animation: none; }
.bee-awake[data-icon="signal"] .bee-eyes > :nth-child(3) { animation: none; }
.bee-awake[data-icon="signal"] .bee-eyes > :nth-child(4) { animation: none; }
.group:hover .bee-awake[data-icon="signal"] .bee-eyes > :nth-child(1) { animation: bee-blink 0.9s ease-in-out; }
.group:hover .bee-awake[data-icon="signal"] .bee-eyes > :nth-child(2) { animation: bee-blink 0.9s ease-in-out 0.08s; }
.group:hover .bee-awake[data-icon="signal"] .bee-eyes > :nth-child(3) { animation: bee-blink 0.9s ease-in-out 0.04s; }
.group:hover .bee-awake[data-icon="signal"] .bee-eyes > :nth-child(4) { animation: bee-blink 0.9s ease-in-out 0.12s; }

/* blink: bloom */
.group:hover .bee-awake[data-icon="bloom"] .bee-eyes > :nth-child(1) { animation: bee-blink 0.9s ease-in-out; }
.group:hover .bee-awake[data-icon="bloom"] .bee-eyes > :nth-child(2) { animation: bee-blink 0.9s ease-in-out 0.06s; }

/* look-around (left-eye-first): cross, crown */
.group:hover .bee-awake:is([data-icon="cross"], [data-icon="crown"]) .bee-eyes > :nth-child(1) { animation: bee-look-leye 1.2s ease-in-out; }
.group:hover .bee-awake:is([data-icon="cross"], [data-icon="crown"]) .bee-eyes > :nth-child(2) { animation: bee-look-reye 1.2s ease-in-out; }

/* look-around (right-eye-first): shield, tilt, tower */
.group:hover .bee-awake:is([data-icon="shield"], [data-icon="tilt"], [data-icon="tower"]) .bee-eyes > :nth-child(1) { animation: bee-look-reye 1.2s ease-in-out; }
.group:hover .bee-awake:is([data-icon="shield"], [data-icon="tilt"], [data-icon="tower"]) .bee-eyes > :nth-child(2) { animation: bee-look-leye 1.2s ease-in-out; }

/* ── Awake hover: piece animations per bee type ── */

/* signal: wings flutter, bar pulses */
.group:hover .bee-awake[data-icon="signal"] svg > path:nth-of-type(1) { transform-origin: 50.1% 64.2%; animation: bee-flutter-l 0.6s ease-in-out; }
.group:hover .bee-awake[data-icon="signal"] svg > path:nth-of-type(2) { transform-origin: 40.4% 15.1%; animation: bee-flutter-r 0.6s ease-in-out 0.05s; }
.group:hover .bee-awake[data-icon="signal"] svg > path:nth-of-type(3) { transform-box: fill-box; transform-origin: center; animation: bee-pulse 0.5s ease-in-out 0.1s; }

/* cross: 4 quarters flutter */
.group:hover .bee-awake[data-icon="cross"] svg > path:nth-of-type(1) { transform-origin: 12.3% 56.2%; animation: bee-flutter-l 0.5s ease-in-out; }
.group:hover .bee-awake[data-icon="cross"] svg > path:nth-of-type(2) { transform-origin: 12.6% 43.7%; animation: bee-flutter-r 0.5s ease-in-out 0.06s; }
.group:hover .bee-awake[data-icon="cross"] svg > path:nth-of-type(3) { transform-origin: 87.3% 43.7%; animation: bee-flutter-l 0.5s ease-in-out 0.12s; }
.group:hover .bee-awake[data-icon="cross"] svg > path:nth-of-type(4) { transform-origin: 87.3% 56.2%; animation: bee-flutter-r 0.5s ease-in-out 0.18s; }

/* crown: points flutter, bars bob */
.group:hover .bee-awake[data-icon="crown"] svg > path:nth-of-type(1) { transform-origin: 62.6% 15.7%; animation: bee-flutter-l 0.5s ease-in-out; }
.group:hover .bee-awake[data-icon="crown"] svg > path:nth-of-type(2) { transform-origin: 37.5% 15.7%; animation: bee-flutter-r 0.5s ease-in-out 0.06s; }
.group:hover .bee-awake[data-icon="crown"] svg > rect:nth-of-type(1) { animation: bee-bob 0.4s ease-in-out 0.08s; }
.group:hover .bee-awake[data-icon="crown"] svg > rect:nth-of-type(2) { animation: bee-bob 0.4s ease-in-out 0.16s; }

/* shield: wings flutter, bars bob */
.group:hover .bee-awake[data-icon="shield"] svg > path:nth-of-type(1) { transform-origin: 28.2% 49.9%; animation: bee-flutter-l 0.55s ease-in-out; }
.group:hover .bee-awake[data-icon="shield"] svg > path:nth-of-type(2) { transform-origin: 72.0% 49.7%; animation: bee-flutter-r 0.55s ease-in-out 0.05s; }
.group:hover .bee-awake[data-icon="shield"] svg > rect:nth-of-type(1) { animation: bee-bob 0.4s ease-in-out 0.04s; }
.group:hover .bee-awake[data-icon="shield"] svg > rect:nth-of-type(2) { animation: bee-bob 0.4s ease-in-out 0.12s; }
.group:hover .bee-awake[data-icon="shield"] svg > rect:nth-of-type(3) { animation: bee-bob 0.4s ease-in-out 0.2s; }

/* bloom: 4 petals flutter, bar bobs */
.group:hover .bee-awake[data-icon="bloom"] svg > path:nth-of-type(1) { transform-origin: 56.0% 47.2%; animation: bee-flutter-r 0.5s ease-in-out; }
.group:hover .bee-awake[data-icon="bloom"] svg > path:nth-of-type(2) { transform-origin: 52.4% 43.6%; animation: bee-flutter-l 0.5s ease-in-out 0.07s; }
.group:hover .bee-awake[data-icon="bloom"] svg > path:nth-of-type(3) { transform-origin: 46.6% 44.1%; animation: bee-flutter-r 0.5s ease-in-out 0.14s; }
.group:hover .bee-awake[data-icon="bloom"] svg > path:nth-of-type(4) { transform-origin: 43.0% 47.6%; animation: bee-flutter-l 0.5s ease-in-out 0.21s; }
.group:hover .bee-awake[data-icon="bloom"] svg > rect:nth-of-type(1) { animation: bee-bob 0.4s ease-in-out 0.12s; }

/* tower: bars bob, wings flutter */
.group:hover .bee-awake[data-icon="tower"] svg > rect:nth-of-type(1) { animation: bee-bob 0.45s ease-in-out; }
.group:hover .bee-awake[data-icon="tower"] svg > rect:nth-of-type(2) { animation: bee-bob 0.45s ease-in-out 0.1s; }
.group:hover .bee-awake[data-icon="tower"] svg > path:nth-of-type(1) { transform-origin: 28.1% 31.1%; animation: bee-flutter-l 0.5s ease-in-out 0.05s; }
.group:hover .bee-awake[data-icon="tower"] svg > path:nth-of-type(2) { transform-origin: 71.9% 31.3%; animation: bee-flutter-r 0.5s ease-in-out 0.1s; }

/* tilt: slash rocks, wings flutter */
.group:hover .bee-awake[data-icon="tilt"] svg > path:nth-of-type(1) { transform-box: fill-box; transform-origin: center; --br: 5deg; animation: bee-rock 0.55s ease-in-out; }
.group:hover .bee-awake[data-icon="tilt"] svg > path:nth-of-type(2) { transform-origin: 68.8% 31.4%; animation: bee-flutter-r 0.5s ease-in-out 0.06s; }
.group:hover .bee-awake[data-icon="tilt"] svg > path:nth-of-type(3) { transform-origin: 43.4% 31.2%; animation: bee-flutter-l 0.5s ease-in-out 0.12s; }

/* ── Sleeping: collapsed + idle twitches ── */
.bee-sleeping svg {
...
/* sporadic piece twitches (idle) */
.bee-sleeping[data-icon="signal"] svg > path:nth-of-type(1) { transform-origin: 50.1% 64.2%; animation: bee-twitch 4s ease-in-out infinite 1.5s; }
.bee-sleeping[data-icon="shield"] svg > path:nth-of-type(2) { transform-origin: 72.0% 49.7%; animation: bee-twitch 5s ease-in-out infinite 0.5s; }
.bee-sleeping[data-icon="tower"] svg > path:nth-of-type(1) { transform-origin: 28.1% 31.1%; animation: bee-twitch 4s ease-in-out infinite 3.2s; }
.bee-sleeping[data-icon="bloom"] svg > path:nth-of-type(3) { transform-origin: 46.6% 44.1%; animation: bee-twitch 4.5s ease-in-out infinite 1s; }
.bee-sleeping[data-icon="tilt"] svg > path:nth-of-type(2) { transform-origin: 68.8% 31.4%; animation: bee-twitch 3.5s ease-in-out infinite 4s; }

/* sleeping hover: breathe, suppress piece twitches */
...
export function BeeAvatar({
  ...
  const fill = sleeping ? "#a2a9b0" : "black";
  const render = bees[idx]!;
  return (
    <div
      className={cn(
        "bee-avatar size-10 shrink-0 self-center",
        sleeping ? "bee-sleeping" : "bee-awake",
        className,
      )}
      data-icon={BEE_NAMES[idx]}
    >
      {render(fill, sleeping)}
    </div>
  );
}
