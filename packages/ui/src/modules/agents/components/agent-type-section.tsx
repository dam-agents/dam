...
function SlackIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      <path
        d="M3.36 10.08a1.68 1.68 0 11-1.68-1.68h1.68v1.68zm.84 0a1.68 1.68 0 113.36 0v4.24a1.68 1.68 0 11-3.36 0v-4.24z"
        fill="#E01E5A"
      />
      <path
        d="M5.88 3.36a1.68 1.68 0 111.68-1.68v1.68H5.88zm0 .84a1.68 1.68 0 110 3.36H1.68a1.68 1.68 0 110-3.36h4.2z"
        fill="#36C5F0"
      />
      <path
        d="M12.64 5.88a1.68 1.68 0 111.68 1.68h-1.68V5.88zm-.84 0a1.68 1.68 0 11-3.36 0V1.68a1.68 1.68 0 113.36 0v4.2z"
        fill="#2EB67D"
      />
      <path
        d="M10.12 12.64a1.68 1.68 0 11-1.68 1.68v-1.68h1.68zm0-.84a1.68 1.68 0 110-3.36h4.2a1.68 1.68 0 110 3.36h-4.2z"
        fill="#ECB22E"
      />
    </svg>
  );
