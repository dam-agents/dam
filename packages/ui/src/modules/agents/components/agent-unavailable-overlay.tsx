 ...
 * Gates the chat/terminal beneath it and surfaces the lifecycle state. A
 * hibernated agent starts by itself once its chat opens (useAutoWakeOnOpen), so
 * the buttons here serve the two states that need a deliberate click: Start
 * retries the budget gate for a parked agent, Restart recovers an errored one.
