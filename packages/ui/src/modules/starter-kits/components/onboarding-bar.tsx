...
/**
 * UNIT_BOUNDARY_DESCRIPTION: The bar above the chat composer while a kit
 * agent's onboarding is pending: the kit's name and how many of the steps the
 * agent reported are done, with the ticked list on hover. Dismiss hides it
 * for that agent in this browser — the row tag keeps showing the state.
 * Mount it keyed by agent so the dismissal is read afresh per agent.
 */
