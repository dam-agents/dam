...
/**
 * UNIT_BOUNDARY_DESCRIPTION: The body of the onboarding hover cards — the
 * steps the agent reported, ticked as it goes — shared by the row tag and the
 * chat bar so the two never disagree. Before the agent has set a list it says
 * what onboarding is instead of showing an empty one.
 */
