...
export function PermissionStatusLine() {
  ...
  return (
    <div className="flex items-center gap-2 rounded-lg border border-border bg-muted/30 px-4 min-h-[44px] text-[14px] anim-in">
    ...
    <div className="px-4 md:px-8 pt-3 pb-4">
      <ChatColumn className="flex flex-col gap-2">
        <div className="rounded-xl border border-border bg-muted/30 px-4 py-3.5 flex flex-col gap-3">
          <div className="flex items-start gap-2 text-[14px] font-semibold text-foreground">
          ...
          {(clampable || expanded) && (
            <button
              ...
              className="self-start pl-4 text-[12px] text-muted-foreground hover:text-foreground transition-colors"
            >
