...
func TestBuildGatewayStatefulSet_Shape(t *testing.T) {
	...
	ss := BuildGatewayStatefulSet("my-instance", false, testAgent, testConfig, testOwnerCM, secrets)
...
func TestBuildGatewayStatefulSet_Hibernated(t *testing.T) {
	ss := BuildGatewayStatefulSet("my-instance", true, testAgent, testConfig, testOwnerCM, nil)
...
func TestBuildGatewayStatefulSet_AutomountSAFalse(t *testing.T) {
	ss := BuildGatewayStatefulSet("my-instance", false, testAgent, testConfig, testOwnerCM, nil)
...
func TestBuildForkGatewayPod_Labels(t *testing.T) {
	pod := BuildForkGatewayPod("fork-abc", "parent-instance", testAgent, testConfig, testForkOwnerCM, nil)
