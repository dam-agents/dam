...
const configSchema = z.object({
  ...
  hostedLlmBaseUrl: z.string().url().optional(),
  hostedLlmModel: z.string().default("claude-opus-5"),
  hostedLlmApiKey: z.string().optional(),
...
export function loadConfig(): Config {
  return validatedConfigSchema.parse({
    ...
    hostedLlmBaseUrl: process.env.HOSTED_LLM_BASE_URL,
    hostedLlmModel: process.env.HOSTED_LLM_MODEL,
    hostedLlmApiKey: process.env.HOSTED_LLM_API_KEY,
