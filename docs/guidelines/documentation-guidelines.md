...
- Measured in characters. Per-page cap (applies to every page at any nesting depth) plus a harder cap on the always-loaded landing page ([`docs/architecture.md`](../architecture.md)).
