...
| [065](065-shared-crds-multi-env.md)           | Shared CRDs across co-located environments — single owner release, release-compat CI gate — ownership mechanism superseded by ADR-066 | @jezekra1 |
| [066](066-operator-applied-crds.md)           | Frozen shared CRDs — operator-applied schema upgrades | @jezekra1 |
